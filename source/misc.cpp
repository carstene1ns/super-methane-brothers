...
//------------------------------------------------------------------------------
// Initialise the rainbow font object
// On Entry:
// 	Not Used
// On Exit:
// 	Not Used
...
//------------------------------------------------------------------------------
// Set a char rising, then wobble, then off screen
// On Entry:
// 	frame = Frame to show
//		xpos = X offset
//		yoffset = Offset from the centre of the screen when wobbling
//		delay = Number of frames to delay before rising takes place
// On Exit:
// 	Not Used
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
// Do the object initial rising to the centre of the screen
// On Entry:
// 	Not Used
// On Exit:
// 	Not Used
...
//------------------------------------------------------------------------------
// Do the object rising off the screen
// On Entry:
// 	Not Used
// On Exit:
// 	Not Used
...
// Setup the day
// On Entry:
// 	xpos,ypos = Where to display the day
// On Exit:
// 	Not Used
//------------------------------------------------------------------------------
...
//static OBJSIZE oil_size2 = { 0, 10, 16, 5 };
...
// Setup the oil
// On Entry:
// 	xpos,ypos = Where to display the oil
...
// Setup the water
// On Entry:
// 	xpos,ypos = Where to display the water
//		(This function also sets the inertias)
// On Exit:
// 	Not Used
//------------------------------------------------------------------------------
...
// Setup the fire
// On Entry:
// 	xpos,ypos = Where to display the fire
//		(This function also sets the inertias)
// On Exit:
// 	Not Used
//------------------------------------------------------------------------------
...
// Setup the marble
// On Entry:
// 	xpos,ypos = Where to display the marble
//		(This function also sets the inertias)
// On Exit:
// 	Not Used
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
// Do the noteman releasing notes
// On Entry:
// 	Not Used
// On Exit:
// 	Not Used
...
// Setup the keyroom
// On Entry:
// 	keytype = How many keys collected (1 to 4)
// On Exit:
// 	Not Used
//------------------------------------------------------------------------------
